...
<div class="row">
    <div class="col-sm-4 mt-2 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/pdf/Topo20Maforai.pdf' | relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-2 mt-2 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/pdf/Topo10Maforai.pdf' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
